        ...
        public async Task<IActionResult> Index(string cityID)
        {
            if (!string.IsNullOrEmpty(cityID))
            {
                ...
                var request = new HttpRequestMessage
                {
                    ...
                    RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v2/hotels/search?checkin_date=2026-02-02&checkout_date=2026-02-04&filter_by_currency=EUR&dest_id={cityID}&room_number=1&units=metric&dest_type=city&locale=en-gb&adults_number=2&order_by=popularity&page_number=0&children_number=2&include_adjacency=true&children_ages=5%2C0&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1"),
                    Headers =
    {
